...
$eavSetup = $eavSetupFactory->create(['setup' => $setup]);
		$eavSetup->addAttribute(
			...
			'sort_product_by_sales',
			[
                'type' => 'varchar',
                'label' => 'Product Sort By Sale Value',
                'input' => 'text',
                'source' => '',
                'required' => false,
                'default' => '',
		...
		$sampleAttribute = $eavConfig->getAttribute(\Magento\Catalog\Model\Product::ENTITY, 'sort_product_by_sales');
